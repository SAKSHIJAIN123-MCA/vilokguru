...
export function ChaturmasSection() {
  ...
  return (
    <section
      id="chaturmas"
      className="py-24 px-6 bg-gradient-to-br from-orange-50 via-yellow-50 to-amber-100 relative overflow-hidden"
    >
      {/* Decorative background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-12 right-20 w-32 h-32 bg-gradient-to-br from-orange-200/30 to-yellow-200/30 rounded-full blur-3xl animate-float" />
        <div
          className="absolute bottom-16 left-12 w-40 h-40 bg-gradient-to-br from-amber-200/30 to-orange-200/30 rounded-full blur-2xl animate-float"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-6xl font-bold text-orange-700 drop-shadow-sm mb-4">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative group">
              ...
              <div className="absolute -bottom-6 -left-6 w-24 h-24 bg-gradient-to-br from-orange-300/40 to-yellow-300/40 rounded-full animate-float blur-sm" />
            </div>
              ...
              <Card className="bg-gradient-to-br from-white/80 to-yellow-50/50 backdrop-blur-sm border-2 border-orange-200/50 hover:border-orange-300/60 transition-all duration-500 hover:shadow-2xl hover:shadow-yellow-200/30 transform hover:-translate-y-2">
                <CardContent className="p-8">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed font-medium">
                    ...
                    <strong> मुरैना नगर</strong> में संपन्न हुआ।  
                    इस चातुर्मास के दौरान, उनका <strong>पिच्छी परिवर्तन</strong> 
                    <strong>26 अक्टूबर 2025</strong> को हुआ।
                    <br />
                    <br />
                    इस पुण्य अवसर पर, मुनि श्री की <strong>पिच्छी प्राप्त करने</strong> 
                    का सौभाग्य <strong>श्री नरेश कुमार जैन, श्रीमती बबीता जैन, 
                    कु. दीक्षा जैन, कु. साक्षी जैन</strong> एवं 
                    <strong> अनमोल जैन नायक परिवार</strong> को प्राप्त हुआ।
                    <br />
                    <br />
                    यह अवसर श्रद्धा, भाव और समर्पण का अद्भुत संगम था, 
                    जिसने समस्त मोरेना नगर को गुरुभक्ति के रंग में रंग दिया।
                  </p>
                </CardContent>
              </Card>
