...
export function BiographySection() {
  ...
  const biographyData = [
    { label: "नाम", value: "चक्रेश कुमार जैन" },
    { label: "पिता का नाम", value: "श्री कोमल चंद जी जैन" },
    { label: "माता का नाम", value: "श्रीमती सुशीला जी" },
    { label: "भाई", value: "राजकुमार जैन, लालचंद्र जैन" },
    { label: "बहन", value: "बबिता जैन" },
    { label: "जन्म स्थान", value: "ग्राम मुढेरी, दमोह (म.प्र.)" },
    { label: "जन्म तिथि", value: "18 अप्रैल 1981" },
    { label: "प्रतिमा व्रत", value: "परम पूज्य आचार्य श्री 108 आर्जव सागर जी महाराज से" },
    { label: "दीक्षा गुरु", value: "परम पूज्य आचार्य श्री 108 आर्जव सागर महाराज" },
    { label: "दीक्षा दिनांक", value: "11 अक्टूबर 2019" },
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    {biographyData.map((item, index) => (
                      ...
                      >
                        <span className="font-bold text-lg text-orange-800 min-w-fit">{item.label}:</span>
                        <span className="text-lg text-gray-700 font-medium">{item.value}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <Card className="bg-gradient-to-br from-orange-50 to-amber-50 border-2 border-orange-200/50 hover:shadow-xl transition-all duration-300 rounded-2xl">
                    <CardContent className="p-6">
                      <h4 className="text-xl font-bold text-orange-800 mb-4">प्रारंभिक जीवन</h4>
                      <p className="text-gray-700 leading-relaxed">
                        मुनि श्री विलोक सागर जी महाराज का जन्म 18 अप्रैल 1981 को ग्राम मुढेरी, दमोह में हुआ था। बचपन से ही उनमें
                        धार्मिक संस्कार और आध्यात्मिकता के प्रति गहरी रुचि थी।
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-gradient-to-br from-amber-50 to-yellow-50 border-2 border-amber-200/50 hover:shadow-xl transition-all duration-300 rounded-2xl">
                    <CardContent className="p-6">
                      <h4 className="text-xl font-bold text-amber-800 mb-4">दीक्षा यात्रा</h4>
                      <p className="text-gray-700 leading-relaxed">
                        उन्होंने परम पूज्य आचार्य श्री 108 आर्जव सागर जी महाराज से प्रतिमा व्रत लिया और 11 अक्टूबर 2019 को भोपाल में
                        दीक्षा ग्रहण की।
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-gradient-to-br from-yellow-50 to-orange-50 border-2 border-yellow-200/50 hover:shadow-xl transition-all duration-300 rounded-2xl">
                    <CardContent className="p-6">
                      <h4 className="text-xl font-bold text-yellow-800 mb-4">वर्तमान सेवा</h4>
                      <p className="text-gray-700 leading-relaxed">
                        आज वे अहिंसा, सत्य, और करुणा के सिद्धांतों का प्रचार करते हैं और समाज कल्याण के कार्यों में सक्रिय रहते हैं।
                      </p>
                    </CardContent>
                  </Card>
                </div>
